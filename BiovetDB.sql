...
--
-- Estructura de tabla para la tabla `ConsultaMedica_has_ProcedimientoQuirurjico`
--

CREATE TABLE `ConsultaMedica_has_ProcedimientoQuirurjico` (
  `fkConsulta` int(11) NOT NULL,
  `fkProcedimientoQuirurjico` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estructura de tabla para la tabla `ProcedimientoQuirurjico`
--

CREATE TABLE `ProcedimientoQuirurjico` (
  `idProcedimientoQuirurjico` int(11) NOT NULL,
  `tipoProcedimientoQuirurjico` varchar(45) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indices de la tabla `ConsultaMedica_has_ProcedimientoQuirurjico`
--
ALTER TABLE `ConsultaMedica_has_ProcedimientoQuirurjico`
  ADD PRIMARY KEY (`fkConsulta`,`fkProcedimientoQuirurjico`),
  ADD KEY `fk_ConsultaMedica_has_ProcedimientoQuirurjico_Procedimiento_idx` (`fkProcedimientoQuirurjico`),
  ADD KEY `fk_ConsultaMedica_has_ProcedimientoQuirurjico_ConsultaMedic_idx` (`fkConsulta`);
...
--
-- Indices de la tabla `ProcedimientoQuirurjico`
--
ALTER TABLE `ProcedimientoQuirurjico`
  ADD PRIMARY KEY (`idProcedimientoQuirurjico`);
...
--
-- AUTO_INCREMENT de la tabla `ProcedimientoQuirurjico`
--
ALTER TABLE `ProcedimientoQuirurjico`
  MODIFY `idProcedimientoQuirurjico` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `ConsultaMedica_has_ProcedimientoQuirurjico`
--
ALTER TABLE `ConsultaMedica_has_ProcedimientoQuirurjico`
  ADD CONSTRAINT `fk_ConsultaMedica_has_ProcedimientoQuirurjico_ConsultaMedica1` FOREIGN KEY (`fkConsulta`) REFERENCES `ConsultaMedica` (`idConsulta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_ConsultaMedica_has_ProcedimientoQuirurjico_ProcedimientoQu1` FOREIGN KEY (`fkProcedimientoQuirurjico`) REFERENCES `ProcedimientoQuirurjico` (`idProcedimientoQuirurjico`) ON DELETE NO ACTION ON UPDATE NO ACTION;
